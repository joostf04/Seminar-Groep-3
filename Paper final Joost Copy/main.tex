...
return, the covariance matrix of forecast errors decomposes as
\begin{equation}\label{eq:ltv-decomp}
    \Sigma_e =
    \underbrace{\mathbb{E}\!\left[\mathrm{Var}(r_{t+1} \mid \mathcal{F}_t)
        \right]\iota\iota'}_{\text{common-return component}}
    \;+\;
...
5, 10, and 15 years for both monthly and quarterly frequencies, and
...
both monthly and quarterly frequencies, and aggregate the resulting
...
methods and both benchmarks, at monthly and quarterly frequencies and
