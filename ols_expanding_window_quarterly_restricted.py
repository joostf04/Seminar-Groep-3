...
fig.tight_layout()
fig.savefig("plot_S_fr_combined_quarterly_restricted.png", dpi=150)
plt.close(fig)
...
ax.grid(True, alpha=0.3)
fig.tight_layout()
fig.savefig("plot_S_p_combined_quarterly_restricted.png", dpi=150)
plt.close(fig)
...
fig.tight_layout()
fig.savefig("plot_pred_vs_eqprem_1994_2000_quarterly_restricted.png", dpi=150)
plt.close(fig)
