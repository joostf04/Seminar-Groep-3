...
# Save results 
out_path2 = "ols_oos_predictions_quarterly_restricted.xlsx"
...
for oos_row in oos_index:
    ...
    F_oos = pca.transform(X_oos * restricted_slopes)
...
print("\n" + "=" * 60)
print("R²_OS — Campbell & Thompson (2008)")
print("=" * 60)
...
fig.tight_layout()
fig.savefig("plot_S_fr_combined_quarterly_restricted.png", dpi=300, bbox_inches="tight")
plt.close(fig)
print("  Saved: plot_S_fr_combined_quarterly_restricted.png")
...
ax.grid(True, alpha=0.3)
fig.tight_layout()
fig.savefig("plot_S_p_combined_quarterly_restricted.png", dpi=300, bbox_inches="tight")
plt.close(fig)
print("  Saved: plot_S_p_combined_quarterly_restricted.png")
...
fig.tight_layout()
fig.savefig("plot_pred_vs_eqprem_1994_2000_quarterly_restricted.png", dpi=300, bbox_inches="tight")
plt.close(fig)
print("  Saved: plot_pred_vs_eqprem_1994_2000_quarterly_restricted.png")
...
for _i, _p in enumerate(forecast_cols):
    ...
    _yi = _dols_y_arr[_p]
    _xi = _dols_x_arr[_p]
    _exp_sign_p = EXPECTED_SIGNS.get(_p, 0)
...
for _dl in DOLS_DELTAS:
    ...
    ax.grid(True, alpha=0.3)
    fig.tight_layout()
    _fname = f"plot_DOLS_S_fr_delta{int(round(_dl*100000))}_quarterly_restricted.png"
...
ax.grid(True, alpha=0.3)
fig.tight_layout()
_fname_png = "plot_return_variance_quarterly_restricted.png"
_fname_pdf = "plot_return_variance_quarterly_restricted.pdf"
...
for W in WINDOWS:
    ...
    _fname_png = f"individual_predictor_corr_quarterly_restricted_W{W}.png"
    _fname_pdf = f"individual_predictor_corr_quarterly_restricted_W{W}.pdf"
    fig.savefig(_fname_png, dpi=300, bbox_inches="tight")
    fig.savefig(_fname_pdf, bbox_inches="tight")
    plt.close(fig)
    print(f"    Saved: {_fname_png} + {_fname_pdf}")
